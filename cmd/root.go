...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.dodas_go_client.yaml)")
	rootCmd.PersistentFlags().StringVar(&templateFile, "template", "", "path to template file")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".dodas_go_client")
	}
